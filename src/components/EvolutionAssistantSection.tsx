      ...
      <div className="container max-w-4xl">
        ...
        >
          ...
          <motion.div
            ...
            className="pt-8"
          >
            <div className="relative inline-block p-[2px] rounded-xl overflow-hidden">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="relative px-8 py-4 text-lg font-bold rounded-xl bg-black text-foreground inline-block"
              >
